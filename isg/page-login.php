...
<div class="login-template" style="
    background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/img/bg-dots-white.jpg);
      ...
      <div class="main-login">
        <div class="box-login">
            ...
            <div class="head-title">
              ...
              <h4><?php esc_html_e( 'กรอกชื่อผู้ใช้ และ รหัสผ่านเพื่อเข้าสู่ระบบ', 'Job989' ); ?></h4>
            </div>
            <form action="" id="form-login" class="form-login" method="POST">
              <div class="main-form">
                  <div class="input-box">
                      <i class="las la-user"></i>
                      <input type="text" name="email" id="email-login" placeholder="ชื่อผู้ใช้" required>
                  </div>
                  <div class="input-box">
                  ...
                  <div class="input-box">
                      <a href="/forget-password/" class="forget-password"><?php esc_html_e( 'ลืมรหัสผ่าน?', 'Job989' ); ?></a>
                  </div>
              </div>
