...
<div class="tempate-box" style="background: url(<?php echo get_stylesheet_directory_uri(); ?>/img/bg-dots-white.jpg);">
    <div class="s-container">
        ...
        <div class="content-form">
          <div class="box-form">
            <div class="box-range">
              <h3><i class="las la-lock"></i> <?php echo esc_html__( 'ลืมรหัสผ่าน ?', 'isg' ); ?></h3>
              <div class="container forget-form">
							<div class="c-form">
								...
								<form id="form-forgetpassword" class="form-forgetpassword" method="post">
									<fieldset>
										<h3><?php esc_html_e( 'โปรดป้อนชื่อผู้ใช้หรือที่อยู่อีเมลของคุณ คุณจะได้รับลิงก์เพื่อสร้างรหัสผ่านใหม่ทางอีเมล', 'isg' ); ?></h3>
										<p class="grid-2"><label for="user_login"><i class="las la-envelope"></i> ที่อยู่อีเมล:</label>
